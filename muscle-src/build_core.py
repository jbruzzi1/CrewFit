#!/usr/bin/env python3
"""Build core icon from the user's high-res Core Image.png.
Crop around red highlight with generous padding, resize to 200x200.
Save as core.png (final) + box_F.png (preview sync)."""
import numpy as np
from PIL import Image
import os, shutil

BASE='/Users/jeffbruzzi/fitness-app'
F=f'{BASE}/.hermes/desktop-attachments/Core Image.png'
...
canvas.save(f'{BASE}/muscle-icons/core.png')
shutil.copy(f'{BASE}/muscle-icons/core.png', f'{BASE}/muscle-icons/box_F.png')
print(f'saved core.png + box_F.png: crop {cw}x{ch} -> {ICON}x{ICON}')
