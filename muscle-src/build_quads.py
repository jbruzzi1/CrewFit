#!/usr/bin/env python3
"""Build quads icon from the user's high-res Quads Image.png.
Crop around red highlight with generous padding, resize to 200x200.
Save as quads.png (final) + box_G.png (preview sync)."""
import numpy as np
from PIL import Image
import os, shutil

BASE='/Users/jeffbruzzi/fitness-app'
F=f'{BASE}/.hermes/desktop-attachments/Quads Image.png'
...
canvas.save(f'{BASE}/muscle-icons/quads.png')
shutil.copy(f'{BASE}/muscle-icons/quads.png', f'{BASE}/muscle-icons/box_G.png')
print(f'saved quads.png + box_G.png: crop {cw}x{ch} -> {ICON}x{ICON}')
