...
const WK_CARDS = [
  ...
  { shot:'taplog',
    ...
    hl:{top:35.26,left:4.87,width:90.26,height:6.84} },
  { shot:'suggested',
  ...
  { shot:'pr',
    title:'Your personal records, always current',
    body:"Progress keeps a running list of your best set for every lift you've logged — it updates the moment you beat it.",
    hl:{top:51.64,left:5.13,width:89.74,height:18.82} },
  { shot:'streak',
    title:'Keep your streak alive',
    body:'Train at least once a week and your streak keeps climbing — the current week is always outlined on the chart. Miss a full week and it resets.',
    hl:{top:27.96,left:4.62,width:53.98,height:15.33} },
  { shot:'feed',
